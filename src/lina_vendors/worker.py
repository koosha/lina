"""VendorSearchWorker — boundary that resolves a query plan into a ResultPacket."""
...
from lina_vendors.connection import OpenSearchConfig
from lina_vendors.packet import ErrorPacket, ResultPacket
from lina_vendors.templates import TEMPLATE_REGISTRY, get_template
from lina_vendors.templates.base import (
    APPROVED_INDICES,
