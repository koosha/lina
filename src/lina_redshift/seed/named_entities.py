...
NAMED_VENDORS: list[Vendor] = [
    Vendor("vendor_walker", "Walker & Associates LLP", "law_firm", "preferred", "US", "USD", True),
    Vendor("vendor_jones", "Jones Privacy Law", "law_firm", "active", "US", "USD", False),
    Vendor("vendor_meridian", "Meridian Counsel UK", "law_firm", "active", "GB", "GBP", True),
]
...
NAMED_MATTERS: list[Matter] = [
    ...
    Matter(
        "matter_acme_privacy_review",
        "ADV-2024-042",
        "Acme Privacy Program Review",
        "advisory",
        "Privacy",
        "open",
        "US",
    ...
    Matter(
        "matter_acme_employment_2023",
        "EMP-2023-007",
        "Smith v. Acme Employment",
        "employment",
        "Employment",
        "closed",
        "NY",
