"""Subsystem A index runner — thin wrapper that binds the core runner to the A state index."""
...
@dataclass
class IndexRunner:
    """Subsystem-A flavored runner — fixes `state_index` to `lina_users_index_state`."""
